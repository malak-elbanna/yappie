...
profile_bp.route('/<int:user_id>/get-books', methods=['GET'])(profile_controller.get_favorite_books)
...
profile_bp.route('/<int:user_id>/add-book', methods=['PUT'])(profile_controller.add_favorite_book)
