    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-800 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl w-full mx-auto px-4 py-8 space-y-6">
                <div className="bg-gray-800 bg-opacity-50 rounded-xl p-4 sm:p-6 backdrop-blur-sm shadow-lg border border-gray-700">
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="w-full md:w-1/3 space-y-6">
                                <div className="relative group">
                                    <img
                                        className="w-24 h-24 sm:w-32 sm:h-32 mx-auto rounded-full shadow-lg border-4 border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300"
                                        src="https://i.pravatar.cc/300"
                                        alt="User Avatar"
                                    />
                                </div>
                                <div className="text-center">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-100">{userInfo.name}</h2>
                            ...
                            <div className="w-full md:flex-1 bg-gray-800/40 rounded-2xl p-4 sm:p-6 border border-gray-700/50">
                                <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-4">Add a Preference</h3>
        ...
        <div className="bg-gray-800 bg-opacity-50 rounded-xl p-4 sm:p-6 backdrop-blur-sm shadow-lg border border-gray-700">
            <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-100">Favorite Books</h3>
                </div>
